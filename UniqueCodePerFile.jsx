...
function mySetup() {
	...
	try{
		...
		//Create a dialog
		var dlg = new Window('dialog', "Code Generator");  
	      
	    dlg.panel = dlg.add('panel', undefined, "Insert the total");  
	...
	app.activeDocument.exportFile(ExportFormat.pdfType, File(Folder.desktop + "/" + finalName + ".pdf"), false);
}